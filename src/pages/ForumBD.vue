...
export default {
  ...
  data() {
    return {
      ...
      posts: [
        { autor: 'Miguel', curtidas: 25, compartilhamentos: 52, texto: 'Os sistemas de gerenciamento de banco de dados (SGBDs) fornecem uma variedade de recursos para gerenciar dados, incluindo adicionar, modificar e excluir registros, além de executar consultas complexas para recuperar informações específicas.' },
        { autor: 'Rodrigo', curtidas: 55, compartilhamentos: 71, texto: ' A segurança dos dados é uma preocupação importante em bancos de dados. Os SGBDs oferecem recursos para proteger os dados contra acesso não autorizado, como autenticação, autorização e criptografia.' },
        { autor: 'Alicia', curtidas: 30, compartilhamentos: 41, texto: ' É essencial ter mecanismos de backup e recuperação robustos para proteger os dados contra perda ou corrupção. Os SGBDs oferecem ferramentas para realizar backups regulares e restaurar os dados em caso de falha.' },
      ],
