<template>
  <v-app id="inspire">
    <v-main>
      ...
      <v-app-bar app prominent color="#fcb69f" dark src="../assets/ronronclub.jpg">
        ...
        <v-app-bar-title>RonRonclub</v-app-bar-title>
...
import CardsForum from '../components/CardsForum.vue'
