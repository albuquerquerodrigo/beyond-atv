...
export default {
  ...
  data() {
    return {
      ...
      posts: [
        { autor: 'Miguel', curtidas: 25, compartilhamentos: 52, texto: 'A POO permite abstrair os detalhes complexos de um sistema, criando objetos que encapsulam dados e funcionalidades relacionadas. Isso facilita a compreensão e o gerenciamento do código.' },
        { autor: 'Rodrigo', curtidas: 55, compartilhamentos: 71, texto: 'Herança é um conceito-chave na POO que permite a criação de novas classes com base em classes existentes. Isso promove a reutilização de código e facilita a extensão e personalização de funcionalidades.' },
        { autor: 'Alicia', curtidas: 30, compartilhamentos: 41, texto: 'A POO promove a modularidade ao dividir um sistema em objetos independentes que interagem por meio de interfaces bem definidas. Isso facilita a construção, teste e manutenção de sistemas complexos.' },
      ],
